...
Test:
python data_process/prepare_datasets.py --annot-dir datasets/Test/Annotation/ --output-dir datasets/Test/Test_normed/1/ --stage test datasets/Test/Images_stainNormed/1/
'''
