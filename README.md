...
5. (Optional) Download our stain augmented testing images [here](https://drive.google.com/file/d/1pIuq4g80B_S1qJuX1EM8ESfYR1c9bxOs/view?usp=sharing). Extract to `datasets/Test`
6. (Optional) Download our pre-trained models [here](). Extract to `BEDs`.
